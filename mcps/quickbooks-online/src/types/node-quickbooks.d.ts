declare module "node-quickbooks" {
  export default class QuickBooks {
    ...
    findEstimates(
      options: object,
      callback: (err: any, estimates: any) => void,
    ): void;
    createEstimate(
      estimateData: object,
      callback: (err: any, estimate: any) => void,
    ): void;
    ...
    createVendor(
      vendor: object,
      callback: (err: any, vendor: any) => void,
    ): void;
    updateVendor(
      vendor: object,
      callback: (err: any, vendor: any) => void,
    ...
    findEmployees(
      options: object,
      callback: (err: any, employees: any) => void,
    ): void;
    createEmployee(
      employeeData: object,
      callback: (err: any, employee: any) => void,
    ): void;
    ...
    findJournalEntries(
      options: object,
      callback: (err: any, journalEntries: any) => void,
    ): void;
    createJournalEntry(
      journalEntryData: object,
      callback: (err: any, journalEntry: any) => void,
    ): void;
    getJournalEntry(
      id: string,
      callback: (err: any, journalEntry: any) => void,
    ...
    findBillPayments(
      options: object,
      callback: (err: any, billPayments: any) => void,
    ): void;
    createBillPayment(
      billPaymentData: object,
      callback: (err: any, billPayment: any) => void,
    ): void;
    getBillPayment(
      id: string,
      callback: (err: any, billPayment: any) => void,
    ...
    findPurchases(
      options: object,
      callback: (err: any, purchases: any) => void,
    ): void;
    createPurchase(
      purchaseData: object,
