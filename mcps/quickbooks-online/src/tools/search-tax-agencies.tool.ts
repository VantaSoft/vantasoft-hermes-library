...
const toolDescription =
  "Search for tax agencies in QuickBooks Online with optional filters.";
...
const toolHandler = async ({ params }: any) => {
  ...
  return {
    content: [
      {
        type: "text" as const,
        text: `Found ${response.result.length} tax agencies:`,
      },
...
export const SearchTaxAgenciesTool: ToolDefinition<typeof toolSchema> = {
  name: toolName,
