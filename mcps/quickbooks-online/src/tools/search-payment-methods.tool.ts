...
const toolDescription =
  "Search for payment methods in QuickBooks Online with optional filters.";
...
const toolHandler = async ({ params }: any) => {
  ...
  return {
    content: [
      {
        type: "text" as const,
        text: `Found ${response.result.length} payment methods:`,
      },
...
export const SearchPaymentMethodsTool: ToolDefinition<typeof toolSchema> = {
  name: toolName,
