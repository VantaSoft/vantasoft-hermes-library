...
const toolDescription =
  "Search for departments in QuickBooks Online with optional filters.";
...
const toolHandler = async ({ params }: any) => {
  ...
  return {
    content: [
      {
        type: "text" as const,
        text: `Found ${response.result.length} departments:`,
      },
...
export const SearchDepartmentsTool: ToolDefinition<typeof toolSchema> = {
  name: toolName,
