...
const toolDescription =
  "Search for classes in QuickBooks Online with optional filters.";
...
const toolHandler = async ({ params }: any) => {
  ...
  return {
    content: [
      {
        type: "text" as const,
        text: `Found ${response.result.length} classes:`,
      },
...
export const SearchClassesTool: ToolDefinition<typeof toolSchema> = {
  name: toolName,
