...
const toolDescription =
  "Generate a Customer Balance report from QuickBooks Online showing outstanding balances by customer.";
...
export const GetCustomerBalanceTool: ToolDefinition<typeof toolSchema> = {
  name: toolName,
