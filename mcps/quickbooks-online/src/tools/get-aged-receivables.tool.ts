...
const toolSchema = z.object({
  ...
  aging_method: z
    ...
    .optional()
    .describe("Aging method"),
  days_per_aging_period: z
    .number()
    .optional()
    .describe("Days per aging period (default 30)"),
  num_periods: z
    .number()
    .optional()
    .describe("Number of aging periods (default 4)"),
});
...
export const GetAgedReceivablesTool: ToolDefinition<typeof toolSchema> = {
  name: toolName,
