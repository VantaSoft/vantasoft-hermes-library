...
const { getQuickbooksBalanceSheet } = await import(
  "../../../src/handlers/get-quickbooks-balance-sheet.handler"
);
const { getQuickbooksProfitAndLoss } = await import(
  "../../../src/handlers/get-quickbooks-profit-and-loss.handler"
);
const { getQuickbooksCashFlow } = await import(
  "../../../src/handlers/get-quickbooks-cash-flow.handler"
);
const { getQuickbooksTrialBalance } = await import(
  "../../../src/handlers/get-quickbooks-trial-balance.handler"
);
const { getQuickbooksGeneralLedger } = await import(
  "../../../src/handlers/get-quickbooks-general-ledger.handler"
);
const { getQuickbooksCustomerSales } = await import(
  "../../../src/handlers/get-quickbooks-customer-sales.handler"
);
const { getQuickbooksAgedReceivables } = await import(
  "../../../src/handlers/get-quickbooks-aged-receivables.handler"
);
const { getQuickbooksCustomerBalance } = await import(
  "../../../src/handlers/get-quickbooks-customer-balance.handler"
);
const { getQuickbooksAgedPayables } = await import(
  "../../../src/handlers/get-quickbooks-aged-payables.handler"
);
const { getQuickbooksVendorExpenses } = await import(
  "../../../src/handlers/get-quickbooks-vendor-expenses.handler"
);
const { getQuickbooksVendorBalance } = await import(
  "../../../src/handlers/get-quickbooks-vendor-balance.handler"
);
...
describe("Report Handlers", () => {
  ...
  describe("getQuickbooksBalanceSheet", () => {
    it("should get balance sheet report", async () => {
      ...
      mockQuickBooksInstance.reportBalanceSheet.mockImplementation(
        (params: any, cb: any) => cb(null, mockReport),
      );
    ...
    it("should handle errors", async () => {
      mockQuickBooksInstance.reportBalanceSheet.mockImplementation(
        (params: any, cb: any) => cb(new Error("Report failed"), null),
      );
  ...
  describe("getQuickbooksProfitAndLoss", () => {
    it("should get P&L report", async () => {
      ...
      mockQuickBooksInstance.reportProfitAndLoss.mockImplementation(
        (params: any, cb: any) => cb(null, mockReport),
      );
  ...
  describe("getQuickbooksCashFlow", () => {
    it("should get cash flow report", async () => {
      ...
      mockQuickBooksInstance.reportCashFlow.mockImplementation(
        (params: any, cb: any) => cb(null, mockReport),
      );
  ...
  describe("getQuickbooksTrialBalance", () => {
    it("should get trial balance report", async () => {
      ...
      mockQuickBooksInstance.reportTrialBalance.mockImplementation(
        (params: any, cb: any) => cb(null, mockReport),
      );
  ...
  describe("getQuickbooksGeneralLedger", () => {
    it("should get general ledger report", async () => {
      ...
      mockQuickBooksInstance.reportGeneralLedgerDetail.mockImplementation(
        (params: any, cb: any) => cb(null, mockReport),
      );
  ...
  describe("getQuickbooksCustomerSales", () => {
    it("should get customer sales report", async () => {
      ...
      mockQuickBooksInstance.reportCustomerSales.mockImplementation(
        (params: any, cb: any) => cb(null, mockReport),
      );
  ...
  describe("getQuickbooksAgedReceivables", () => {
    it("should get aged receivables report", async () => {
      ...
      mockQuickBooksInstance.reportAgedReceivables.mockImplementation(
        (params: any, cb: any) => cb(null, mockReport),
      );
  ...
  describe("getQuickbooksCustomerBalance", () => {
    it("should get customer balance report", async () => {
      ...
      mockQuickBooksInstance.reportCustomerBalance.mockImplementation(
        (params: any, cb: any) => cb(null, mockReport),
      );
  ...
  describe("getQuickbooksAgedPayables", () => {
    it("should get aged payables report", async () => {
      ...
      mockQuickBooksInstance.reportAgedPayables.mockImplementation(
        (params: any, cb: any) => cb(null, mockReport),
      );
  ...
  describe("getQuickbooksVendorExpenses", () => {
    it("should get vendor expenses report", async () => {
      ...
      mockQuickBooksInstance.reportVendorExpenses.mockImplementation(
        (params: any, cb: any) => cb(null, mockReport),
      );
  ...
  describe("getQuickbooksVendorBalance", () => {
    it("should get vendor balance report", async () => {
      ...
      mockQuickBooksInstance.reportVendorBalance.mockImplementation(
        (params: any, cb: any) => cb(null, mockReport),
      );
