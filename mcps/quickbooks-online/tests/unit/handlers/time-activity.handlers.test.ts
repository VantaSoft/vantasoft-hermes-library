...
const { createQuickbooksTimeActivity } = await import(
  "../../../src/handlers/create-quickbooks-time-activity.handler"
);
const { getQuickbooksTimeActivity } = await import(
  "../../../src/handlers/get-quickbooks-time-activity.handler"
);
const { updateQuickbooksTimeActivity } = await import(
  "../../../src/handlers/update-quickbooks-time-activity.handler"
);
const { deleteQuickbooksTimeActivity } = await import(
  "../../../src/handlers/delete-quickbooks-time-activity.handler"
);
const { searchQuickbooksTimeActivities } = await import(
  "../../../src/handlers/search-quickbooks-time-activities.handler"
);
...
describe("TimeActivity Handlers", () => {
  ...
  describe("createQuickbooksTimeActivity", () => {
    it("should create a time activity for vendor", async () => {
      ...
      mockQuickBooksInstance.createTimeActivity.mockImplementation(
        (payload: any, cb: any) => cb(null, mockActivity),
      );
    ...
    it("should handle errors", async () => {
      mockQuickBooksInstance.createTimeActivity.mockImplementation(
        (payload: any, cb: any) => cb(new Error("Invalid data"), null),
      );
  ...
  describe("getQuickbooksTimeActivity", () => {
    it("should get a time activity by ID", async () => {
      const mockActivity = { Id: "123", Hours: 8 };
      mockQuickBooksInstance.getTimeActivity.mockImplementation(
        (_id: any, cb: any) => cb(null, mockActivity),
      );
  ...
  describe("updateQuickbooksTimeActivity", () => {
    it("should update a time activity", async () => {
      ...
      mockQuickBooksInstance.updateTimeActivity.mockImplementation(
  ...
  describe("deleteQuickbooksTimeActivity", () => {
    it("should delete a time activity", async () => {
      mockQuickBooksInstance.deleteTimeActivity.mockImplementation(
        (payload: any, cb: any) => cb(null, {}),
      );

      const result = await deleteQuickbooksTimeActivity({
        id: "123",
        sync_token: "0",
      });
  ...
  describe("searchQuickbooksTimeActivities", () => {
    it("should search time activities", async () => {
      ...
      mockQuickBooksInstance.findTimeActivities.mockImplementation(
        (criteria: any, cb: any) =>
