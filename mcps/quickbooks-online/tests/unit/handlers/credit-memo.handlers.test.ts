...
const { createQuickbooksCreditMemo } = await import(
  "../../../src/handlers/create-quickbooks-credit-memo.handler"
);
const { getQuickbooksCreditMemo } = await import(
  "../../../src/handlers/get-quickbooks-credit-memo.handler"
);
const { updateQuickbooksCreditMemo } = await import(
  "../../../src/handlers/update-quickbooks-credit-memo.handler"
);
const { deleteQuickbooksCreditMemo } = await import(
  "../../../src/handlers/delete-quickbooks-credit-memo.handler"
);
const { searchQuickbooksCreditMemos } = await import(
  "../../../src/handlers/search-quickbooks-credit-memos.handler"
);
...
describe("CreditMemo Handlers", () => {
  ...
  describe("createQuickbooksCreditMemo", () => {
    it("should create a credit memo successfully", async () => {
      ...
      mockQuickBooksInstance.createCreditMemo.mockImplementation(
        (payload: any, cb: any) => cb(null, mockMemo),
      );
      ...
      const payload = (
        mockQuickBooksInstance.createCreditMemo.mock.calls[0] as any
      )[0];
    ...
    it("should handle errors", async () => {
      mockQuickBooksInstance.createCreditMemo.mockImplementation(
        (payload: any, cb: any) => cb("Error occurred", null),
      );
  ...
  describe("getQuickbooksCreditMemo", () => {
    it("should get a credit memo by ID", async () => {
      ...
      mockQuickBooksInstance.getCreditMemo.mockImplementation(
        (_id: any, cb: any) => cb(null, mockMemo),
      );
  ...
  describe("updateQuickbooksCreditMemo", () => {
    it("should update a credit memo", async () => {
      ...
      mockQuickBooksInstance.updateCreditMemo.mockImplementation(
  ...
  describe("deleteQuickbooksCreditMemo", () => {
    it("should delete a credit memo", async () => {
      mockQuickBooksInstance.deleteCreditMemo.mockImplementation(
        (payload: any, cb: any) => cb(null, {}),
      );

      const result = await deleteQuickbooksCreditMemo({
        id: "123",
        sync_token: "0",
      });
  ...
  describe("searchQuickbooksCreditMemos", () => {
    it("should search credit memos", async () => {
      ...
      mockQuickBooksInstance.findCreditMemos.mockImplementation(
        (criteria: any, cb: any) =>
