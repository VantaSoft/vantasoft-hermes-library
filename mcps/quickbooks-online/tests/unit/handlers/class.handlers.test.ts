...
const { createQuickbooksClass } = await import(
  "../../../src/handlers/create-quickbooks-class.handler"
);
const { getQuickbooksClass } = await import(
  "../../../src/handlers/get-quickbooks-class.handler"
);
const { updateQuickbooksClass } = await import(
  "../../../src/handlers/update-quickbooks-class.handler"
);
const { searchQuickbooksClasses } = await import(
  "../../../src/handlers/search-quickbooks-classes.handler"
);
...
describe("Class Handlers", () => {
  ...
  describe("createQuickbooksClass", () => {
    it("should create a class successfully", async () => {
      ...
      mockQuickBooksInstance.createClass.mockImplementation(
        (payload: any, cb: any) => cb(null, mockClass),
      );
    ...
    it("should create a sub-class with parent", async () => {
      ...
      const result = await createQuickbooksClass({
        name: "Digital",
        parent_ref: "123",
      });
    ...
    it("should handle errors", async () => {
      mockQuickBooksInstance.createClass.mockImplementation(
        (payload: any, cb: any) => cb(new Error("Duplicate name"), null),
      );
  ...
  describe("updateQuickbooksClass", () => {
    it("should update a class", async () => {
      ...
      mockQuickBooksInstance.updateClass.mockImplementation(
        (payload: any, cb: any) => cb(null, mockUpdated),
      );

      const result = await updateQuickbooksClass({
        id: "123",
        sync_token: "0",
  ...
  describe("searchQuickbooksClasses", () => {
    it("should search classes", async () => {
      ...
      mockQuickBooksInstance.findClasses.mockImplementation(
        (criteria: any, cb: any) =>
    ...
    it("should search with filters", async () => {
      mockQuickBooksInstance.findClasses.mockImplementation(
        (criteria: any, cb: any) => cb(null, { QueryResponse: { Class: [] } }),
      );
