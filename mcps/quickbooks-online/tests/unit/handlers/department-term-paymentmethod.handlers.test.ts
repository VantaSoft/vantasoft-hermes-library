...
const { createQuickbooksDepartment } = await import(
  "../../../src/handlers/create-quickbooks-department.handler"
);
const { getQuickbooksDepartment } = await import(
  "../../../src/handlers/get-quickbooks-department.handler"
);
const { updateQuickbooksDepartment } = await import(
  "../../../src/handlers/update-quickbooks-department.handler"
);
const { searchQuickbooksDepartments } = await import(
  "../../../src/handlers/search-quickbooks-departments.handler"
);
const { createQuickbooksTerm } = await import(
  "../../../src/handlers/create-quickbooks-term.handler"
);
const { getQuickbooksTerm } = await import(
  "../../../src/handlers/get-quickbooks-term.handler"
);
const { updateQuickbooksTerm } = await import(
  "../../../src/handlers/update-quickbooks-term.handler"
);
const { searchQuickbooksTerms } = await import(
  "../../../src/handlers/search-quickbooks-terms.handler"
);
const { createQuickbooksPaymentMethod } = await import(
  "../../../src/handlers/create-quickbooks-payment-method.handler"
);
const { getQuickbooksPaymentMethod } = await import(
  "../../../src/handlers/get-quickbooks-payment-method.handler"
);
const { updateQuickbooksPaymentMethod } = await import(
  "../../../src/handlers/update-quickbooks-payment-method.handler"
);
const { searchQuickbooksPaymentMethods } = await import(
  "../../../src/handlers/search-quickbooks-payment-methods.handler"
);
  ...
  describe("Department Handlers", () => {
    describe("createQuickbooksDepartment", () => {
      it("should create a department", async () => {
        ...
        mockQuickBooksInstance.createDepartment.mockImplementation(
          (payload: any, cb: any) => cb(null, mockDept),
        );
      ...
      it("should create with parent", async () => {
        ...
        const result = await createQuickbooksDepartment({
          name: "West Coast",
          parent_ref: "1",
        });
    ...
    describe("getQuickbooksDepartment", () => {
      it("should get a department", async () => {
        const mockDept = { Id: "1", Name: "Sales" };
        mockQuickBooksInstance.getDepartment.mockImplementation(
          (_id: any, cb: any) => cb(null, mockDept),
        );
    ...
    describe("updateQuickbooksDepartment", () => {
      it("should update a department", async () => {
        mockQuickBooksInstance.updateDepartment.mockImplementation(
          (payload: any, cb: any) => cb(null, {}),
        );

        const result = await updateQuickbooksDepartment({
          id: "1",
          sync_token: "0",
          name: "Marketing",
          active: true,
    ...
    describe("searchQuickbooksDepartments", () => {
      it("should search departments", async () => {
        ...
        mockQuickBooksInstance.findDepartments.mockImplementation(
          (criteria: any, cb: any) =>
  ...
  describe("Term Handlers", () => {
    describe("createQuickbooksTerm", () => {
      it("should create a term", async () => {
        ...
        mockQuickBooksInstance.createTerm.mockImplementation(
          (payload: any, cb: any) => cb(null, mockTerm),
        );
    ...
    describe("updateQuickbooksTerm", () => {
      it("should update a term", async () => {
        mockQuickBooksInstance.updateTerm.mockImplementation(
          (payload: any, cb: any) => cb(null, {}),
        );
    ...
    describe("searchQuickbooksTerms", () => {
      it("should search terms", async () => {
        ...
        mockQuickBooksInstance.findTerms.mockImplementation(
          (criteria: any, cb: any) =>
  ...
  describe("PaymentMethod Handlers", () => {
    describe("createQuickbooksPaymentMethod", () => {
      it("should create a payment method", async () => {
        ...
        mockQuickBooksInstance.createPaymentMethod.mockImplementation(
          (payload: any, cb: any) => cb(null, mockMethod),
        );

        const result = await createQuickbooksPaymentMethod({
          name: "Credit Card",
          type: "CREDIT_CARD",
        });
    ...
    describe("getQuickbooksPaymentMethod", () => {
      it("should get a payment method", async () => {
        mockQuickBooksInstance.getPaymentMethod.mockImplementation(
          (_id: any, cb: any) => cb(null, {}),
        );
    ...
    describe("updateQuickbooksPaymentMethod", () => {
      it("should update a payment method", async () => {
        mockQuickBooksInstance.updatePaymentMethod.mockImplementation(
          (payload: any, cb: any) => cb(null, {}),
        );

        const result = await updateQuickbooksPaymentMethod({
          id: "1",
          sync_token: "0",
          name: "Visa",
          active: true,
    ...
    describe("searchQuickbooksPaymentMethods", () => {
      it("should search payment methods", async () => {
        ...
        mockQuickBooksInstance.findPaymentMethods.mockImplementation(
          (criteria: any, cb: any) =>
