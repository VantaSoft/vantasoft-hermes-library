...
const { getQuickbooksTaxCode } = await import(
  "../../../src/handlers/get-quickbooks-tax-code.handler"
);
const { searchQuickbooksTaxCodes } = await import(
  "../../../src/handlers/search-quickbooks-tax-codes.handler"
);
const { getQuickbooksTaxRate } = await import(
  "../../../src/handlers/get-quickbooks-tax-rate.handler"
);
const { searchQuickbooksTaxRates } = await import(
  "../../../src/handlers/search-quickbooks-tax-rates.handler"
);
const { getQuickbooksTaxAgency } = await import(
  "../../../src/handlers/get-quickbooks-tax-agency.handler"
);
const { searchQuickbooksTaxAgencies } = await import(
  "../../../src/handlers/search-quickbooks-tax-agencies.handler"
);
...
describe("Tax Entity Handlers", () => {
  ...
  describe("getQuickbooksTaxCode", () => {
    it("should get a tax code by ID", async () => {
      ...
      mockQuickBooksInstance.getTaxCode.mockImplementation(
        (_id: any, cb: any) => cb(null, mockTaxCode),
      );
  ...
  describe("searchQuickbooksTaxCodes", () => {
    it("should search tax codes", async () => {
      ...
      mockQuickBooksInstance.findTaxCodes.mockImplementation(
        (criteria: any, cb: any) =>
  ...
  describe("getQuickbooksTaxRate", () => {
    it("should get a tax rate by ID", async () => {
      ...
      mockQuickBooksInstance.getTaxRate.mockImplementation(
        (_id: any, cb: any) => cb(null, mockTaxRate),
      );
  ...
  describe("searchQuickbooksTaxRates", () => {
    it("should search tax rates", async () => {
      ...
      mockQuickBooksInstance.findTaxRates.mockImplementation(
        (criteria: any, cb: any) =>
  ...
  describe("getQuickbooksTaxAgency", () => {
    it("should get a tax agency by ID", async () => {
      ...
      mockQuickBooksInstance.getTaxAgency.mockImplementation(
        (_id: any, cb: any) => cb(null, mockTaxAgency),
      );
  ...
  describe("searchQuickbooksTaxAgencies", () => {
    it("should search tax agencies", async () => {
      ...
      mockQuickBooksInstance.findTaxAgencies.mockImplementation(
        (criteria: any, cb: any) =>
