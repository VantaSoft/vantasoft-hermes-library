...
const { createQuickbooksVendor } = await import(
  "../../../src/handlers/create-quickbooks-vendor.handler"
);
const { getQuickbooksVendor } = await import(
  "../../../src/handlers/get-quickbooks-vendor.handler"
);
const { updateQuickbooksVendor } = await import(
  "../../../src/handlers/update-quickbooks-vendor.handler"
);
const { deleteQuickbooksVendor } = await import(
  "../../../src/handlers/delete-quickbooks-vendor.handler"
);
const { searchQuickbooksVendors } = await import(
  "../../../src/handlers/search-quickbooks-vendors.handler"
);
...
describe("Vendor Handlers", () => {
  ...
  describe("createQuickbooksVendor", () => {
    it("should create a vendor successfully", async () => {
      ...
      mockQuickBooksInstance.createVendor.mockImplementation(
        (_payload: any, cb: any) => cb(null, mockVendor),
      );
  ...
  describe("updateQuickbooksVendor", () => {
    it("should update a vendor", async () => {
      ...
      mockQuickBooksInstance.updateVendor.mockImplementation(
  ...
  describe("deleteQuickbooksVendor", () => {
    it("should delete a vendor", async () => {
      ...
      mockQuickBooksInstance.deleteVendor.mockImplementation(
  ...
  describe("searchQuickbooksVendors", () => {
    it("should search vendors", async () => {
      const mockVendors = [
        { Id: "56", DisplayName: "Acme" },
        { Id: "57", DisplayName: "Globex" },
      ];
      mockQuickBooksInstance.findVendors.mockImplementation(
    ...
    it("should search vendors with array criteria", async () => {
      mockQuickBooksInstance.findVendors.mockImplementation(
        (_criteria: any, cb: any) =>
          cb(null, {
            QueryResponse: { Vendor: [{ Id: "56", DisplayName: "Acme" }] },
          }),
      );
