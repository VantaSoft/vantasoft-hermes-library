...
const { createQuickbooksDeposit } = await import(
  "../../../src/handlers/create-quickbooks-deposit.handler"
);
const { getQuickbooksDeposit } = await import(
  "../../../src/handlers/get-quickbooks-deposit.handler"
);
const { updateQuickbooksDeposit } = await import(
  "../../../src/handlers/update-quickbooks-deposit.handler"
);
const { deleteQuickbooksDeposit } = await import(
  "../../../src/handlers/delete-quickbooks-deposit.handler"
);
const { searchQuickbooksDeposits } = await import(
  "../../../src/handlers/search-quickbooks-deposits.handler"
);
const { createQuickbooksTransfer } = await import(
  "../../../src/handlers/create-quickbooks-transfer.handler"
);
const { getQuickbooksTransfer } = await import(
  "../../../src/handlers/get-quickbooks-transfer.handler"
);
const { updateQuickbooksTransfer } = await import(
  "../../../src/handlers/update-quickbooks-transfer.handler"
);
const { deleteQuickbooksTransfer } = await import(
  "../../../src/handlers/delete-quickbooks-transfer.handler"
);
const { searchQuickbooksTransfers } = await import(
  "../../../src/handlers/search-quickbooks-transfers.handler"
);
...
describe("Deposit and Transfer Handlers", () => {
  ...
  describe("Deposit Handlers", () => {
    it("should create a deposit", async () => {
      ...
      mockQuickBooksInstance.createDeposit.mockImplementation(
        (payload: any, cb: any) => cb(null, mockDeposit),
      );
    ...
    it("should get a deposit", async () => {
      mockQuickBooksInstance.getDeposit.mockImplementation(
    ...
    it("should update a deposit", async () => {
      mockQuickBooksInstance.updateDeposit.mockImplementation(
    ...
    it("should delete a deposit", async () => {
      mockQuickBooksInstance.deleteDeposit.mockImplementation(
        (payload: any, cb: any) => cb(null, {}),
      );

      const result = await deleteQuickbooksDeposit({
        id: "1",
        sync_token: "0",
      });
    ...
    it("should search deposits", async () => {
      mockQuickBooksInstance.findDeposits.mockImplementation(
        (criteria: any, cb: any) =>
    ...
    it("should handle search errors", async () => {
      mockQuickBooksInstance.findDeposits.mockImplementation(
        (criteria: any, cb: any) => cb(new Error("API Error"), null),
      );
    ...
    it("should pass date filters in the array/operator format node-quickbooks parses", async () => {
      ...
      await searchQuickbooksDeposits({
        txn_date_from: "2024-01-01",
        txn_date_to: "2024-12-31",
        limit: 50,
      });
  ...
  describe("Transfer Handlers", () => {
    it("should create a transfer", async () => {
      ...
      mockQuickBooksInstance.createTransfer.mockImplementation(
        (payload: any, cb: any) => cb(null, mockTransfer),
      );
    ...
    it("should get a transfer", async () => {
      mockQuickBooksInstance.getTransfer.mockImplementation(
        (_id: any, cb: any) => cb(null, { Id: "1" }),
      );
    ...
    it("should update a transfer", async () => {
      mockQuickBooksInstance.updateTransfer.mockImplementation(
        (payload: any, cb: any) => cb(null, {}),
      );
    ...
    it("should delete a transfer", async () => {
      mockQuickBooksInstance.deleteTransfer.mockImplementation(
        (payload: any, cb: any) => cb(null, {}),
      );

      const result = await deleteQuickbooksTransfer({
        id: "1",
        sync_token: "0",
      });
    ...
    it("should search transfers", async () => {
      mockQuickBooksInstance.findTransfers.mockImplementation(
        (criteria: any, cb: any) =>
    ...
    it("should pass date filters in the array/operator format node-quickbooks parses", async () => {
      ...
      await searchQuickbooksTransfers({
        txn_date_from: "2024-01-01",
        txn_date_to: "2024-12-31",
        limit: 50,
      });
