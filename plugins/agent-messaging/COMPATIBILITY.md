...
The plugin is maintained and tested with the VantaSoft Hermes Agent runtime. Compatible deployments can install this directory from the public VantaSoft Hermes Library. It has no independent wheel or package entry point.
